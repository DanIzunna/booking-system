...
export function deleteAvailabilityWindow(
  ...
  return apiRequest<void>(
    `${basePath(bookableId)}/windows/${encodeURIComponent(windowId)}`,
    {
      method: "DELETE",
    },
  );
...
export function listAvailabilityExceptions(
  ...
  return apiRequest<AvailabilityException[]>(
    `${basePath(bookableId)}/exceptions`,
  );
}
...
export function deleteAvailabilityException(
  ...
  return apiRequest<void>(
    `${basePath(bookableId)}/exceptions/${encodeURIComponent(exceptionId)}`,
    {
      method: "DELETE",
    },
  );
...
export function checkAvailability(
  ...
  return apiRequest<AvailabilityCheckResult>(
    `${basePath(bookableId)}/check?${query.toString()}`,
  );
}
