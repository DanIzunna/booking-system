...
export default function BookablePage({ params }: BookablePageProps) {
  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}><Link className={styles.logo} href="/">Booking System</Link><button className={styles.signOut} type="button" onClick={() => void logout()}>Sign out</button></header>
