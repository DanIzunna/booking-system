...
- Name: public-and-forms.spec.ts >> public product surfaces >> public booking explains missing reservation configuration
- Location: tests\e2e\public-and-forms.spec.ts:60:7
...
Call log:
  - waiting for getByRole('textbox', { name: 'Select a date' })
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    - generic [ref=e4]:
      - link "B Bookable" [ref=e5] [cursor=pointer]:
        - /url: /
        - generic [ref=e6]: B
        - generic [ref=e7]: Bookable
      - generic [ref=e8]: Public catalog
    - generic [ref=e11]:
      - heading "This organization is unavailable" [level=1] [ref=e12]
      - paragraph [ref=e13]: Check the link and try again.
      - link "Return to Bookable" [ref=e14] [cursor=pointer]:
        - /url: /
    - generic [ref=e16]:
      - generic [ref=e17]:
        - link "Bookable" [ref=e18] [cursor=pointer]:
          - /url: /
        - paragraph [ref=e19]: Make anything bookable
      - paragraph [ref=e20]: © 2026 Bookable
